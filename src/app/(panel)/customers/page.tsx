      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl">Clientes y fiados</h1>
          </div>
          <p className="text-sm text-muted-foreground">Cuenta corriente, límites de crédito y saldos pendientes.</p>
        </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="hover:bg-transparent">
                  ...
                  <TableHead className="pr-6 text-right">Deuda</TableHead>
                </TableRow>
              </TableHeader>
                    ...
                    return (
                      <TableRow key={x.id} className="hover:bg-muted/40">
                        ...
                        <TableCell className="text-right text-muted-foreground">
                          {money(x.creditLimit.toString())}
                        </TableCell>

                        <TableCell className="pr-6 text-right">
                          <span className={debt > 0 ? "font-semibold text-destructive" : "font-medium text-muted-foreground"}>
                            {money(debt)}
                          </span>
                        </TableCell>
                      </TableRow>
                  ...
                  <TableRow className="hover:bg-transparent">
                    <TableCell colSpan={4}>
                      <div className="flex min-h-52 flex-col items-center justify-center text-center">
                        <ContactRound className="mb-3 size-9 text-muted-foreground/40" />
                        <p className="text-sm font-medium">Sin clientes encontrados</p>
                        <p className="mt-1 text-xs text-muted-foreground">Ajusta la búsqueda o registra un nuevo cliente.</p>
                      </div>
                    </TableCell>
                  </TableRow>
                )}
